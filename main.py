...
def defence(char_name: str, char_class: str) -> str:
    """Функция тренировки защиты персонажа.
    Расчет количества заблокированного урона.
    """
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция тренировки специальных навыков персонажа.
    Возвращает количество единиц навыка.
    """
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция выбора вида тренировки."""
    if char_class == 'warrior':
